/******/ (function(modules) {
  ...
  \********************************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */ var _Device_Device__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ../Device/Device */ "./components/Device/Device.js"
        );

        class AirConditioning extends _Device_Device__WEBPACK_IMPORTED_MODULE_0__[
          "Device"
        ] {
          constructor(name) {
            super(name);
  ...
  \***********************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        class Light extends _Device_Device__WEBPACK_IMPORTED_MODULE_0__[
          "Device"
        ] {
          constructor(name) {
            super(name);
  ...
  \**********************************************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony export (binding) */ __webpack_require__.d(
          ...
          "SmartHouseRender",
          function() {
            return SmartHouseRender;
          }
        );
        /* harmony import */ var _Tv_Tv__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ../Tv/Tv */ "./components/Tv/Tv.js"
        );
        /* harmony import */ var _Light_Light__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../Light/Light */ "./components/Light/Light.js"
        );
        /* harmony import */ var _Air_Conditioning_AirConditioning__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../Air Conditioning/AirConditioning */ "./components/Air Conditioning/AirConditioning.js"
        );
          ...
          render() {
            ...
            buttonAddDevice.addEventListener("click", () => {
              ...
              switch (currentOption) {
                case "tv-set":
                  const newTV = new _Tv_Tv__WEBPACK_IMPORTED_MODULE_0__["Tv"](
                    deviceName
                  );
                  this.smartHouse.addNewDevice(newTV);
                  const viewTV = new _Tv_Tv__WEBPACK_IMPORTED_MODULE_0__[
                    "RenderTV"
                  ](newTV, document.getElementById("root"), this.smartHouse);
                  viewTV.render();
                  break;

                case "light":
                  const newLight = new _Light_Light__WEBPACK_IMPORTED_MODULE_1__[
                    "Light"
                  ](deviceName);
                ...
                case "air_conditioning":
                  const newAirConditioning = new _Air_Conditioning_AirConditioning__WEBPACK_IMPORTED_MODULE_2__[
                    "AirConditioning"
                  ](deviceName);
                  this.smartHouse.addNewDevice(newAirConditioning);
                  const viewAC = new _Air_Conditioning_AirConditioning__WEBPACK_IMPORTED_MODULE_2__[
                    "RenderAC"
                  ](
                    newAirConditioning,
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        ...
        class Tv extends _Device_Device__WEBPACK_IMPORTED_MODULE_0__["Device"] {
          ...
          set currentChannel(channel) {
            if (
              channel >= this._minChannelValue &&
              channel <= this._maxChannelValue
            ) {
          ...
          render() {
            ...
            decreaseChannel.addEventListener("click", () => {
              if (this._tv.isEnabledStatus === true) {
                ...
                currentChannel.innerText = `Channel: ${
                  this._tv.currentChannel
                }`;
              }
            });
  ...
  \**********************/
      ...
      /***/ function(module, __webpack_exports__, __webpack_require__) {
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _components_Smart_House_SmartHouse__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          /*! ../components/Smart House/SmartHouse */ "./components/Smart House/SmartHouse.js"
        );
        /* harmony import */ var _components_Air_Conditioning_AirConditioning__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          /*! ../components/Air Conditioning/AirConditioning */ "./components/Air Conditioning/AirConditioning.js"
        );
        /* harmony import */ var _components_Tv_Tv__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          /*! ../components/Tv/Tv */ "./components/Tv/Tv.js"
        );
        /* harmony import */ var _components_Light_Light__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          /*! ../components/Light/Light */ "./components/Light/Light.js"
        );
        /* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
          /*! ./index.scss */ "./src/index.scss"
        );
        /* harmony import */ var _index_scss__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/ __webpack_require__.n(
          _index_scss__WEBPACK_IMPORTED_MODULE_4__
        );

        const house = new _components_Smart_House_SmartHouse__WEBPACK_IMPORTED_MODULE_0__[
          "SmartHouse"
        ]("My Smart House", "NY, 5th AV", "Oleg Shynkarenko");
        house.registerDevice(
          _components_Tv_Tv__WEBPACK_IMPORTED_MODULE_2__["Tv"]
        );
        house.registerDevice(
          _components_Light_Light__WEBPACK_IMPORTED_MODULE_3__["Light"]
        );
        house.registerDevice(
          _components_Air_Conditioning_AirConditioning__WEBPACK_IMPORTED_MODULE_1__[
            "AirConditioning"
          ]
        );

        const smartHouseView = new _components_Smart_House_SmartHouse__WEBPACK_IMPORTED_MODULE_0__[
          "SmartHouseRender"
        ](house);
